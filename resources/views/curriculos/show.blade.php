...
<div class="row m-4">
    ...
    <div class="col-sm-8  align-self-center">
        ...
        <h4><strong>Video Curriculum:</strong> <iframe width="560" height="315" src="https://www.youtube.com/embed/{{ $curriculo->video_curriculum }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></h4>
