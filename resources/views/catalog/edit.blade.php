                            ...
                            <div class="offset-md-3 col-md-6">
                                <div class="card">
                                    ...
                                    <div class="card-body" style="padding:30px">
                                        ...
                                        <form
                                            action="{{ action([App\Http\Controllers\CatalogController::class, 'putEdit'], ['id' => $id]) }}"
                                            method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre" id="nombre"
                                                    value="{{ $proyecto['nombre'] }}" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label for="docente_id">Docente</label>
                                                <input type="number" name="docente_id"
                                                    value="{{ $proyecto['docente_id'] }}" id="docente_id">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dominio" id="dominio"
                                                    value="{{ $proyecto['dominio'] }}" class="form-control">
                                            </div>
