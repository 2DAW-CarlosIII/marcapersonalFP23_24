            ...
            <div class="card-body" style="padding:30px">
                ...
                <form action="{{ action([App\Http\Controllers\CatalogController::class, 'putEdit'], ['id' => $id]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$proyecto['nombre']}}" type="text" name="nombre" id="nombre" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="docente_id">Docente</label>
                        <input value="{{$proyecto['docente_id']}}" type="number" name="docente_id" id="docente_id">
                    </div>

                    <div class="form-group">
                        <label for="dominio">Dominio</label><br />
                        https://github.com/2DAW-CarlosIII/
                        <input value="{{$proyecto['dominio']}}" type="text" name="dominio" id="dominio" class="form-control">
                    </div>
