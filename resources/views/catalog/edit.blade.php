                ...
                <div class="card-body" style="padding:30px">
                    ...
                    {{ print_r($proyecto['metadatos'], true) }}
                        ...
                        <div class="form-group">
                            ...
                            <input min="1" max="10" type="number" name="calificacion" id="calificacion"
                        ...
                        <div class="form-group">
                            <label for="proyecto">Subir proyecto</label>
                            @if ($proyecto->proyecto)
                                <label for="proyecto-nombre">{{ $proyecto->proyecto }}</label>
                            @else
                                <label for="proyecto-nombre">No hay ningun proyecto subido.</label>
                            @endif
                            <input type="file" class="form-control" id="proyecto" name="proyecto"
