    ...
    <div class="row m-4">
        ...
        <div class="col-sm-8  align-self-center">
            ...
            <a class="btn btn-warning"
                href="{{ action([App\Http\Controllers\EstudianteController::class, 'getEdit'], ['id' => $estudiante->id]) }}">
                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                Editar Estudiante
            </a>

            <a class="btn btn-outline-info"
                href="{{ action([App\Http\Controllers\EstudianteController::class, 'getIndex']) }}">
                Volver al listado
            </a>
        </div>
    </div>
