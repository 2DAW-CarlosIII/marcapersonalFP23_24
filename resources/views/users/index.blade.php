            ...
            <div class="col-4 col-6-medium col-12-small">
                <section class="box">
                    <a href="#" class="image featured" title="Nice and Serious, CC0, via Wikimedia Commons"><img
                        ...
                        @if ($arrayUsers[$i]['avatar'])
                            <img src="{{ Storage::url($arrayUsers[$i]['avatar']) }}" alt="Avatar" class="img-thumbnail">
                        @else
                    ...
                    <footer>
                        <ul class="actions text-center">
                            <li><a href="{{ action([App\Http\Controllers\UserController::class, 'getShow'], ['id' => $i]) }}"
