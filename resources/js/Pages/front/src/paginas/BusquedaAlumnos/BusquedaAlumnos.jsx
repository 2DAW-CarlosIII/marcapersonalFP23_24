                ...
                <div className="col-md-12">
                    <div className="card ">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-text">{dropPerfilC.dropImg ? <ListaPerfilesCompetenciales damePerfilesSeleccionados = {damePerfilesSeleccionados} visible="listaVisible"></ListaPerfilesCompetenciales>
                                                                              : <ListaPerfilesCompetenciales damePerfilesSeleccionados = {damePerfilesSeleccionados} visible="listaOculta"></ListaPerfilesCompetenciales>} </div>
                                ...
                                <div className="card-text">{dropFamilia.dropImg ? <ListaFamiliaProfesionales dameFamiliasSeleccionadas = {dameFamiliasSeleccionadas} visible="listaVisible"></ListaFamiliaProfesionales>
                                                                              : <ListaFamiliaProfesionales dameFamiliasSeleccionadas = {dameFamiliasSeleccionadas} visible="listaOculta"></ListaFamiliaProfesionales>}</div>
                            </div>
