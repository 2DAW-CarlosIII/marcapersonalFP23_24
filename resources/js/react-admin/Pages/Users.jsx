...
export const UserEdit = () => (
    <Edit title={<UserTitle />}>
        <SimpleForm>
            ...
            <ImageInput source="attachments" label="Imagen del avatar" style={{ border: '2px dashed #ccc', padding: '10px', maxWidth: '180px' }}>
...
export const UserShow = () => (
    <Show>
        <SimpleShowLayout>
            <ImageField source="attachments.src" title="avatar.title" label="Foto de perfil" />
            <TextField source="id" />
