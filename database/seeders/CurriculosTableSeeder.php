...
class CurriculosTableSeeder extends Seeder
{
    private static $arrayCurriculos = [
        ...
        [
            'user_id' => 7,
            'video_curriculum' => 'https://https://www.youtube.com/watch?v=fabDpTOfKns',
