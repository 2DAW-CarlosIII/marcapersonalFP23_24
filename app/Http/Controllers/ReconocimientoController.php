...
class ReconocimientoController extends Controller
{
    public function getIndex(){
        return view('reconocimiento.index',['arrayReconocimientos'=>$this->arrayReconocimientos]);
    }

    public function getShow($id)
    {
        return view('reconocimiento.show')
            ->with('arrayReconocimientos', $this->arrayReconocimientos[$id])
            ->with('id', $id);
    }

    public function putEdit($id) {
        return view('reconocimiento.edit')
            ->with("arrayReconocimientos",$this->arrayReconocimientos[$id])
            ->with("id",$id);
    }
