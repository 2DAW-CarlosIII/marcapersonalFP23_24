...
class CurriculoController extends Controller
{
    public function getIndex(){
        return view('curriculos.index', ['arrayCurriculos' => $this->arrayCurriculos]);
    }

    public function getShow($id){
        return view('curriculos.show', ['curriculo' => $this->arrayCurriculos[$id], 'id' => $id]);
    }
    ...
    public function getEdit($id){
        return view('curriculos.edit', ['curriculo' => $this->arrayCurriculos[$id], 'id' => $id]);
    }
